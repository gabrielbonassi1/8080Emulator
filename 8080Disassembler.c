...
pc is the corrent offset into the code
...
int Disassemble8080(unsigned char *codebuffer, int pc){
    ...
    case 0x01: printf("LXI    B,#$%02x%02x", code[2], code[1]); opbytes=3; break; /* LXI rp, data 16 - Load register pair immediate Pair B & C*/
    ...
    case 0x11: printf("LXI    D,#$%02x%02x", code[2], code[1]); opbytes=3; break; /*Load register pair immediate Pair D & E*/
    case 0x12: printf("STAX   D"); break; /*Store accumulator indirect*/
    case 0x13: printf("INX    D"); break; /*Increment register pair*/
    ...
    case 0x23: printf("INX    H"); break; /*Increment register pair*/
    ...
    case 0x2a: printf("LHLD   #$%02x", code[1]); opbytes=2; break; /*Load H & L direct*/
	...
	case 0x33: printf("INX    SP"); break; /*Increment stack ponter*/
	...
	case 0x3c: printf("INR    A"); break; /*Increase register*/
	case 0x3d: printf("DCR    A"); break; /*Decrease register*/
	case 0x3e: printf("MVI    A,#$%02x", code[1]); opbytes = 2; break; /*Move immediate register*/
	case 0x3f: printf("CMC"); break; /*Complement carry*/
			
	case 0x40: printf("MOV    B,B"); break; /*Move register to register (B -> B)*/
	case 0x41: printf("MOV    B,C"); break; /*Move register to register (B -> C)*/
	case 0x42: printf("MOV    B,D"); break; /*Move register to register (B -> D)*/
	case 0x43: printf("MOV    B,E"); break;
	case 0x44: printf("MOV    B,H"); break;
	case 0x45: printf("MOV    B,L"); break;
	case 0x46: printf("MOV    B,M"); break; /*Move register to memory (B -> M)*/
	...
	case 0x70: printf("MOV    M,B"); break; /*Move memory to register (M -> B)*/
	case 0x71: printf("MOV    M,C"); break;
	case 0x72: printf("MOV    M,D"); break;
	case 0x73: printf("MOV    M.E"); break;
	case 0x74: printf("MOV    M,H"); break;
	case 0x75: printf("MOV    M,L"); break;
	case 0x76: printf("HLT"); break; /*Halt*/
	...
	case 0x90: printf("SUB    B"); break; /*Subtract register from A*/
	case 0x91: printf("SUB    C"); break;
	case 0x92: printf("SUB    D"); break;
	case 0x93: printf("SUB    E"); break;
	case 0x94: printf("SUB    H"); break;
	case 0x95: printf("SUB    L"); break;
	case 0x96: printf("SUB    M"); break; /*Subtract memory from A*/
	case 0x97: printf("SUB    A"); break;
	case 0x98: printf("SBB    B"); break; /*Subtract register from A with borrow*/
	...
	case 0xc3: printf("JMP    $%02x%02x",code[2],code[1]); opbytes = 3; break; /*Jump unconditioal*/
	...
	case 0xcd: printf("CALL   $%02x%02x",code[2],code[1]); opbytes = 3; break; /*Call unconditional*/
	case 0xce: printf("ACI    #$%02x",code[1]); opbytes = 2; break; /*Add immediate to A with carry*/
	...
	case 0xd3: printf("OUT    #$%02x",code[1]); opbytes = 2; break; /*Outpip*/
	...
	case 0xe9: printf("PCHL"); break; /*H & L to program conuter*/
	case 0xea: printf("JPE    $%02x%02x",code[2],code[1]); opbytes = 3; break; /*Jump on parity even*/
	case 0xeb: printf("XCHG"); break; /*Exchante D & E, H & L registers*/
	...
	case 0xf9: printf("SPHL");break; /*H & L to stack pointer*/
